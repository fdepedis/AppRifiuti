class Strings {
  ...
  static const String rup =
      "I farmaci scaduti o non utilizzati devono essere immessi esclusivamente negli appositi contenitori installati presso le farmacie. Le pile esauste devono essere consegnate presso i rivenditori autorizzati alla vendita che sono tenuti a ritirarle, oppure immesse negli appositi contenitori presso tabaccai e supermercati.";
  static const String vetro =
      "II vetro può essere conferito tutti i giorni nelle campane stradali dedicate. Depositare i rifiuti in vetro dopo averli svuotati del loro contenuto. Il vetro va conferito sfuso e senza sacchetto.";
  static const String olii =
      "Olio di frittura, di oliva e di semi, olio di sortoli, olio di pesce in scatola.";
  static const String toner =
